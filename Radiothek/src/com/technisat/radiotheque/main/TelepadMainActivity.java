...
public class TelepadMainActivity extends Activity implements
	...
	private List<DataObject> generateGridViewObjects() {
		...
		DataObject history = new DataObject(getString(R.string.mainactivity_button_history),R.drawable.ic_home_gehoert, R.color.Grid_Item_history);
		DataObject favs = new DataObject(getString(R.string.mainactivity_button_favs),R.drawable.xxx, R.color.Grid_Item_favs);
		DataObject genre = new DataObject(getString(R.string.mainactivity_button_genre),R.drawable.wrap120_hdpi, R.color.Grid_Item_genre);
		DataObject country = new DataObject(getString(R.string.mainactivity_button_country),R.drawable.ic_home_genre_h3, R.color.Grid_Item_country);
		allData.add(history);
		allData.add(favs);
		allData.add(genre);
		allData.add(country);
