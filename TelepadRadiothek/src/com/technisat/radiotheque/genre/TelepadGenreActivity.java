...
//					Intent i =  new Intent(TelepadGenreActivity.this, MediaPlayerService.class);
...
//				    startService(i);
//				} else {
//					Toast.makeText(TelepadGenreActivity.this, getString(R.string.genreactivity_text_nostationavailable), Toast.LENGTH_SHORT).show();
//				}
//				return;
//			}
//			
